...
function Navbar() {
  ...
  return (
    <nav className={`fixed z-50 w-full text-white p-3 px-6 md:px-16 shadow-md transition-all duration-300 ${scroll ? "bg-black bg-opacity-90" : "bg-transparent"}`}>
      <div className="flex justify-between items-center">
        {/* Logo */}
        <h1 className="text-amber-400 text-2xl font-bold tracking-wide">Restaurant</h1>

        {/* Desktop Navigation */}
        <div className="hidden md:flex items-center gap-8">
          <Link href={"#"} className="hover:text-amber-400 transition">Home</Link>
          <Link href={"#"} className="hover:text-amber-400 transition">Menu</Link>
          <Link href={"#"} className="hover:text-amber-400 transition">About</Link>
          <Link href={"#"} className="hover:text-amber-400 transition">Services</Link>
